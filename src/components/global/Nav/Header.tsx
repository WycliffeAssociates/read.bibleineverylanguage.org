...
import { Index, Show, Suspense, createSignal, lazy } from "solid-js";
import { addDict } from "./I18nContext";
import { HamburgerSvg, MobileMenuOpen } from "./MenuButtons";
...
export function Header(props: HeaderProps) {
	...
	async function changeLanguage(lang: string): Promise<void> {
		...
		let newDictCode: string | undefined;
		...
		menu?.dispatchEvent(changeLanguageEvent);
	...
	return (
		<nav class="w-full bg-darkAccent py-5 font-sans print:hidden">
			<div class="relative mx-auto flex max-w-[75ch] items-center justify-between px-4 text-varBase text-white">
				...
				>
					<ul class="flex flex-col text-base lg:flex-row ltr:pl-4 rtl:pr-4">
					...
					<div class="relative my-2 pl-4 lg:my-0 lg:ml-4 lg:pl-0">
						<button
							...
							class={`languagePicker relative inline-flex place-content-center text-base hover:text-secondary rtl:flex-row-reverse ${
