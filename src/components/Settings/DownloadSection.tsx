	...
	function handleDownloadSubmission() {
		...
		function downloadSingleUsfm() {
			if (props.downloadSourceUsfmArr.length) {
				bttWriterSingleUsfmForm?.submit();
			}
		}
		function downloadWholeUsfm() {
			printWholeUsfmRef?.click();
		}
						...
						{(choice) => (
							...
							>
								...
								<RadioGroup.ItemControl
									...
									class="py-2 text-center hover:border-accent hover:bg-gray-100 focus:outline-2 focus:outline-accent data-[checked]:bg-accent/10 data-[checked]:text-accent/90 h-full"
								>
