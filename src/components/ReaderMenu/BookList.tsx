						...
						<For each={props.bibleMenuBooksByCategory()?.OT}>
							{(book) => (
								<li class="w-full">
									<button
										classList={{
											" w-full text-xl py-2 ltr:text-left rtl:text-right border-y border-gray-100 ltr:pl-4 rtl:pr-4 hover:bg-gray-100 focus:outline-2 focus:outline-accent focus:font-bold": true,
